    ...
    const handleSubmit = async (e: any) => {
        ...
        try {
            if (isForgotPassword) {
                ...
                const res = await axiosInstance.post(API_ENDPOINTS.AUTH_LOGIN, { email: formData.email, password: formData.password });
                ...
                <div style={{ width: "100%", maxWidth: "420px" }}>
                    ...
                    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                        ...
                        <button type="submit" disabled={loading}
                            ...
                            {loading ? (
                                <div style={{ width: "20px", height: "20px", borderRadius: "50%", border: "2px solid rgba(255,255,255,0.3)", borderTopColor: "#fff", animation: "spin 0.8s linear infinite" }} />
                            ) : (
