...
import AttendanceSettingsPage from "@/components/AttendanceSettingsPage";
import { useState } from "react";
import { FiCheckCircle, FiXCircle, FiAlertCircle, FiX } from "react-icons/fi";

export default function AttendanceSettingsRoute() {
    ...
    return (
        <>
            ...
            <AttendanceSettingsPage showNotify={showNotify} />
        </>
    );
}
