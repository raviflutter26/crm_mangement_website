    ...
    return (
        <>
            <div className="page-header">
                <div>
                    <h1 className="page-title">Revenue & Invoices</h1>
                    <p className="page-subtitle">Track project revenue, client invoicing, and payment collection. — {data.length} records found.</p>
                </div>
            ...
            {data.length === 0 ? (
                ...
                <div className="card">
                    <div className="card-header">
                        <h3 className="card-title">Revenue & Invoices</h3>
