...
import PermissionConfigPage from "@/components/PermissionConfigPage";
import { useState } from "react";
import { FiCheckCircle, FiXCircle, FiAlertCircle, FiX } from "react-icons/fi";

export default function PermissionSettingsRoute() {
    ...
    return (
        <>
            ...
            <PermissionConfigPage showNotify={showNotify} />
        </>
    );
}
