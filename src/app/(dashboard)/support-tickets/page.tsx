...
import { FiTag, FiPlus, FiSearch } from "react-icons/fi";
        ...
        <>
            <div className="page-header">
                <div>
                    ...
                    <p className="page-subtitle">View, assign, and resolve internal support requests and issues. — {data.length} records found.</p>
                </div>
