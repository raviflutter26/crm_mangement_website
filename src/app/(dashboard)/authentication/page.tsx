...
import { FiKey, FiPlus, FiSearch } from "react-icons/fi";
    ...
    return (
        <>
            <div className="page-header">
                <div>
                    <h1 className="page-title">Authentication Settings</h1>
                    <p className="page-subtitle">Configure login methods, password policies, and session management. — {data.length} records found.</p>
                </div>
            ...
            {data.length === 0 ? (
                ...
                <div className="card">
                    <div className="card-header">
                        <h3 className="card-title">Authentication Settings</h3>
