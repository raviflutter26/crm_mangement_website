...
import { FiMail, FiPlus, FiSearch } from "react-icons/fi";
        ...
        <>
            <div className="page-header">
                <div>
                    ...
                    <p className="page-subtitle">Configure email templates, notification triggers, and delivery channels. — {data.length} records found.</p>
                </div>
