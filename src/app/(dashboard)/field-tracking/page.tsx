    ...
    return (
        <>
            <div className="page-header">
                <div>
                    <h1 className="page-title">Field Team Tracking</h1>
                    <p className="page-subtitle">Monitor real-time field crew locations and activity across project sites. — {data.length} records found.</p>
                </div>
            ...
            {data.length === 0 ? (
                ...
                <div className="card">
                    <div className="card-header">
                        <h3 className="card-title">Field Team Tracking</h3>
