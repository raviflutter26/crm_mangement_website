        ...
        <>
            <div className="page-header">
                <div>
                    ...
                    <p className="page-subtitle">Restrict system access to trusted IP addresses and network ranges. — {data.length} records found.</p>
                </div>
            ...
            {data.length === 0 ? (
                ...
                <div className="card">
                    <div className="card-header">
                        <h3 className="card-title">IP Allowlist</h3>
