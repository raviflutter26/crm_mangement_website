...
export default function inventoryPage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const res = await axiosInstance.get(API_ENDPOINTS.ASSETS);
    ...
    return (
        <>
            <div className="page-header">
                <div>
                    <h1 className="page-title">Inventory & Materials</h1>
                    <p className="page-subtitle">Track materials, spare parts, and consumables across all project sites. — {data.length} records found.</p>
                </div>
            ...
            {data.length === 0 ? (
                ...
                <div className="card">
                    <div className="card-header">
                        <h3 className="card-title">Inventory & Materials</h3>
