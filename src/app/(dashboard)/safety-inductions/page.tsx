    ...
    return (
        <>
            <div className="page-header">
                <div>
                    <h1 className="page-title">Safety Inductions</h1>
                    <p className="page-subtitle">Manage mandatory safety training and site induction records. — {data.length} records found.</p>
                </div>
            ...
            {data.length === 0 ? (
                ...
                <div className="card">
                    <div className="card-header">
                        <h3 className="card-title">Safety Inductions</h3>
